...
class TestSeaside(tornado.testing.AsyncTestCase):
	...
	def test_Island(self):
		tu.print_test_header("test Island")
		island = sea.Island(self.game, self.player1)
		self.player1.hand.add(island)
		mining_village = intrigue.Mining_Village(self.game, self.player1)
		mining_village.play()
		island.play()
		yield tu.send_input(self.player1, "post_selection", ["Copper"])
		self.assertTrue(len(self.player1.island_pile) == 2)
		self.assertTrue(self.player1.total_vp() == 5)
